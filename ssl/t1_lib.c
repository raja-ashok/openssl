...
static const TLS_GROUP_INFO nid_list[] = {
    ...
    {NID_ffdhe2048, 112, TLS_GROUP_FFDHE, 0x0100}, /* ffdhe2048 (0x0100) */
    {NID_ffdhe3072, 128, TLS_GROUP_FFDHE, 0x0101}, /* ffdhe3072 (0x0101) */
    {NID_ffdhe4096, 140, TLS_GROUP_FFDHE, 0x0102}, /* ffdhe4096 (0x0102) */
    {NID_ffdhe6144, 170, TLS_GROUP_FFDHE, 0x0103}, /* ffdhe6144 (0x0103) */
    {NID_ffdhe8192, 192, TLS_GROUP_FFDHE, 0x0104}, /* ffdhe8192 (0x0104) */
};
                    ...
                    int *groups, size_t ngroups)
{
    ...
    for (i = 0; i < ngroups; i++) {
        ...
        idmask = 1L << (id & 0x00FF);
        dup_list = (id < sizeof(*dup_list)) ? &dup_list_egrp : &dup_list_dhgrp;
